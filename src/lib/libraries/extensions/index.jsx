...
import smartcitizenImage from './crocopoi_smartcitizen.png';
...
export default [
    ...
    },
    {
        name: (
            <FormattedMessage
                defaultMessage="Smartcitizen + Crocopoi"
                description="Understanding Data that matters"
                id="gui.extension.smartcitizen.name"
            />
        ),
        extensionId: 'smartcitizen',
        iconURL: smartcitizenImage,
        description: (
            <FormattedMessage
                defaultMessage="Understanding Data that matters"
                description="Understanding Data that matters"
                id="gui.extension.smartcitizen.description"
            />
        ),
        featured: true,
        helpLink: 'https://scratch.mit.edu/smartcitizen'
    },
    {
        name: 'micro:bit',
